...
=== Lab 1: Hello World [ lab_01_hello_world.rb[link:../labs/lab_01_hello_world.rb] ]
...
=== Lab 2: Prompt user for a name then print it out in reverse [ lab_02_get_name.rb[link:../labs/lab_02_get_name.rb] ]
...
=== Lab 3: Pig Latin [ lab_03_pig_latin.rb[link:../labs/lab_03_pig_latin.rb] ]
...
=== Lab 4: Full-on Pig Latin [ lab_04_full_on_pig_latin.rb[link:../labs/lab_04_full_on_pig_latin.rb] ]
...
=== Lab 5: Grocery List [ lab_05_grocery_list.rb[link:../labs/lab_05_grocery_list.rb] ]
...
=== Lab 6: Grocery List Commentary [ lab_06_grocery_list_commentary.rb[link:../labs/lab_06_grocery_list_commentary.rb] ]
...
=== Lab 7: Implement even?(number) [ lab_07_even.rb[link:../labs/lab_07_even.rb] ]
...
=== Lab 8: Implement Fixnum#even? [ lab_08_fixnum_even.rb[link:../labs/lab_08_fixnum_even.rb] ]
* Open up Fixnum and add your own even method

=== Lab 9: Implement an Animal Class [ lab_09_animal_class.rb[link:../labs/lab_09_animal_class.rb] ]
...
=== Lab 10: Subclass the Animal Class [ lab_10_animal_subclass.rb[link:../labs/lab_10_animal_subclass.rb] ]
* create an animal that has a speak method
...
=== Lab 11: Animal Names [ lab_11_animal_names.rb[link:../labs/lab_11_animal_names.rb] ]
